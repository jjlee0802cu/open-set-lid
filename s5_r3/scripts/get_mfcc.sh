...
do
    ...
    echo $VARIABLE
    lang=$VARIABLE
    mfccdir=../features/mfcc/$lang #mfccdir is the directory to which the data is saved
    ...
    steps/make_mfcc.sh --nj $nj --cmd "$train_cmd" ../data/$lang/train ../features/logs/make_mfcc/train $mfccdir  # run mfcc.sh or mfcc_pitch.sh
    steps/make_mfcc.sh --nj $nj --cmd "$train_cmd" ../data/$lang/test ../features/logs/make_mfcc/train $mfccdir  # run mfcc.sh or mfcc_pitch.sh
